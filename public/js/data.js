...
As the front-end developer, I focused on delivering a seamless user experience with intuitive controls and visually appealing feedback.`,
  ...
  // ── Graphic Design
  {
    cat: 'Graphic Design',
    tab: 'graphic',
    title: '🖼️ Graphic Design Work Coming Soon',
    images: [],
    desc: 'Brand identities, posters, social media graphics, and print designs — coming soon to this portfolio!',
    tags: ['Canva', 'Adobe Illustrator', 'Adobe Photoshop', 'Figma']
  },
  ...
  // ── Video Editing
  {
    cat: 'Video Editing',
    tab: 'video',
    title: '🎬 Video Projects Coming Soon',
    images: [],
    desc: 'Short films, reels, highlights, and content edits — coming soon!',
    tags: ['Adobe Premiere Pro', 'CapCut', 'DaVinci Resolve']
  }
];
...
const TECH_ROW2 = [
  ...
  { name: 'Canva',      img: 'https://upload.wikimedia.org/wikipedia/commons/0/08/Canva_icon_2021.png' },
  { name: 'Framer',     img: 'https://cdn.brandfetch.io/idRjXCqGMq/w/400/h/400/theme/dark/icon.png?k=bfHSJFAPEG' },
